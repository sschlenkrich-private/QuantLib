...
#include <ql/experimental/templatemodels/commodity/all.hpp>
#include <ql/experimental/templatemodels/hullwhite/all.hpp>
...
#include <ql/experimental/templatemodels/qgaussian/all.hpp>
